...
def main():
    ...
    ap.add_argument("--port", type=int, default=7860, help="Port number for the web interface (default: 7860)")
...
# python annot_ui_min_zzq.py --input /data1/home/donglingzhong/codespace/AgentCPM-GUI-Evaluation/cot_eval/data/UI-TARS-1.5-7B/chinese_app_test/sampled.jsonl

# python annot_ui_min_zzq.py --input /data1/home/donglingzhong/codespace/AgentCPM-GUI-Evaluation/cot_eval/data/GUI-Owl-7B/chinese_app_test/sampled.jsonl